...
<div class="author-info">
  <div class="author-image" style="background-image:url('<?php the_field('profile_picture', 'user_'.$authorID); ?>')">
  </div>
  <div class="author-details">
    <h4>By <?php the_author(); ?> <?php if (strlen($twitter = get_field('twitter_username', 'user_'.$authorID)) > 0): ?>(<a href="https://www.twitter.com/<?php echo $twitter; ?>">@<?php echo $twitter; ?></a>)<?php endif; ?></h4>
