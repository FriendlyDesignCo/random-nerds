      ...
      if ($footerQuery->have_posts()): ?>
        <?php while ($footerQuery->have_posts()): $footerQuery->the_post(); ?>
          <footer class="<?php foreach (wp_get_post_categories(get_the_ID()) as $categoryID): $category = get_category($categoryID); ?>category-<?php echo $category->slug; ?><?php endforeach; ?> right">
